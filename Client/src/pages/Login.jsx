...
import { UserOutlined, LockOutlined, GoogleOutlined, Loading3QuartersOutlined } from '@ant-design/icons';
...
const Login = () => {
    ...
    return (
        <div>
            {
                googleAuthLoading && <div className='google-auth-loading'><Loading3QuartersOutlined spin /></div>
            }
            <div className="d-flex justify-content-center" >
                <div className="form-card overlay-bg main-border motion" >
                    <div className="form-card-body p-4">
                        <div className="text-center mb-4">
                            <h1 className="txt4 txt-shadow fw-semibold">Sign in to your account</h1>
                        </div>
