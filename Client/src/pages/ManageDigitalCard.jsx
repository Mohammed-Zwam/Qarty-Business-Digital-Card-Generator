...
import { DeleteOutlined, DownloadOutlined, EditOutlined, ExportOutlined, InfoCircleOutlined, Loading3QuartersOutlined, QrcodeOutlined, ScanOutlined, ShareAltOutlined } from "@ant-design/icons";
import { downloadCanvasQRCode, handleShare } from "../util/QrCodeMethods";
import { deleteDigitalCard, getDigitalCard, updateDigitalCard } from "../api/DigitalCard";
    ...
    return (
        <div style={{ position: "relative" }}>
            ...
            <div className="manage-page d-flex mt-3 justify-content-center align-items-center">
                <div className="form-card overlay-bg main-border motion" style={{ maxWidth: "700px" }}>
                    <div className="form-card-body p-3">
                        <div className="text-center mb-4">
                            <h1 className="display-4 txt4 txt-shadow fw-semibold">Manage Your Digital Card</h1>
                        </div>
        ...
        <div id="info">
            ...
            <div>
                <h3 className="digital-info-title fs-3 mb-3 mt-0 txt2 d-flex algin-items-center gap-2 ">
                    <ScanOutlined className="fs-4 label-icon" style={{ color: "var(--bg-2)" }} />
                    Scan the QR or copy the link below to access your card.
                </h3>
                <div id="myqrcode" className="d-flex align-items-center justify-content-center gap-3 flex-column">
                    <QRCode
                        type={"canvas"}
                        ...
                        size={200}
                    />
                    <Paragraph copyable={{ text: `${import.meta.env.VITE_CLIENT_URL}/card?username=${user.username}&udc=${user.userID}` }} className="fs-6 txt1 m-0 fw-medium">
                ...
                <div className="d-flex align-items-center justify-content-center flex-row gap-3 mb-2">
                    <button className='btn btn-primary align-self-center fs-5 py-1 border-dotted fit-content-width d-flex align-items-center justify-content-center gap-2'
                        onClick={() => { downloadCanvasQRCode(user.digitalCard?.name || user.username, null) }}
                    >
                    ...
                    <button
                        ...
                        onClick={() => { handleShare(user.digitalCard, user.username, user.userID, null) }}
                    >
...
const UpdateComponent = () => {
    ...
    return (
        <div id="update">
            ...
            <div className="p-4" style={{ background: "#09093eff", borderRadius: 10, border: "1px dashed #999" }}>
                {
                    user.digitalCard ?
                        <DigitalCardForm
                            onFinish={onFinish}
...
const DeleteComponent = () => {
    ...
    return (
        <div id="delete">
            ...
            <Modal
                title={<h1 className="fs-1 fw-bold" style={{ color: "darkred" }}>Delete the digital card</h1>}
            ...
            <Button
                ...
                color="danger"
                danger={true}
                loading={deleteLoading && { icon: <div className='d-flex'><Loading3QuartersOutlined spin /></div> }}
