...
import { UserOutlined, LockOutlined, MailOutlined, Loading3QuartersOutlined } from '@ant-design/icons';
                ...
                <div className="form-card overlay-bg main-border motion" >
                    <div className="form-card-body p-4">
                        <div className="text-center mb-4">
                            <h1 className="txt4 txt-shadow fw-semibold">Create your account</h1>
                        </div>
